...
import requests, json, urllib, abc
...
class ElsProfile(ElsEntity, ABC):
    ...
    def __init__(self, uri):
        ...
        super(ElsProfile,self).__init__(uri)
        #super().__init__(uri)
        self._doc_list = None
...
class ElsAuthor(ElsProfile):
    ...
    def __init__(self, uri = '', author_id = ''):
        ...
        if uri and not author_id:
            #super().__init__(uri)
            super(ElsAuthor,self).__init__(uri)
        elif author_id and not uri:
            super(ElsAuthor,self).__init__(self.__uri_base + str(author_id))
...
class ElsAffil(ElsProfile):
    ...
    def __init__(self, uri = '', affil_id = ''):
        ...
        if uri and not affil_id:
            super(ElsAffil,self).__init__(uri)
        elif affil_id and not uri:
             super(ElsAffil,self).__init__(self.__uri_base + str(affil_id))
